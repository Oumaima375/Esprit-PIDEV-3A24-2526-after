 ...
 */
class getCategorieDocumentRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\Categorie_documentRepository' shared autowired service.
     *
     * @return \App\Repository\Categorie_documentRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'Categorie_documentRepository.php';

        return $container->privates['App\\Repository\\Categorie_documentRepository'] = new \App\Repository\Categorie_documentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
