 ...
 */
final class Version20260413090007 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document CHANGE nom_document nom_document VARCHAR(255) NOT NULL, CHANGE chemin_fichier chemin_fichier VARCHAR(500) NOT NULL, CHANGE date_ajout date_ajout DATE NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document CHANGE nom_document nom_document VARCHAR(150) NOT NULL, CHANGE chemin_fichier chemin_fichier VARCHAR(255) NOT NULL, CHANGE date_ajout date_ajout DATE DEFAULT NULL');
