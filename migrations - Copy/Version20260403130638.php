 ...
 */
final class Version20260403130638 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE users CHANGE id id INT NOT NULL, CHANGE telephone telephone VARCHAR(20) NOT NULL, CHANGE photo_profil photo_profil VARCHAR(255) NOT NULL, CHANGE type_utilisateur type_utilisateur VARCHAR(20) NOT NULL, CHANGE is_verified is_verified TINYINT NOT NULL, CHANGE verification_token verification_token VARCHAR(255) NOT NULL, CHANGE verification_expiry verification_expiry DATETIME NOT NULL');
